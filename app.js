...
$(document).ready(function () {
    ...
    var position = new WorldWind.Position(4.2, 102.0, 100.0);
    ...
    globe.addLayerFromWms("https://neo.sci.gsfc.nasa.gov/wms", "MOD_LSTD_CLIM_M", {
        category: "overlay",
        displayName: "Average Land Temperature",
        enabled: false,
        opacity: 0.80
    });
    globe.addLayerFromWms("https://neo.sci.gsfc.nasa.gov/wms", "MY1DMW_CHLORA", {
        category: "overlay",
        displayName: "Chlorophyll  Concentration",
        enabled: false,
        opacity: 0.80
    });
    globe.addLayerFromWms("https://neo.sci.gsfc.nasa.gov/wms", "CERES_NETFLUX_M", {
        category: "overlay",
        displayName: "Net Radiation",
        enabled: false,
        opacity: 0.70
    });
    globe.addLayerFromWms("https://neo.sci.gsfc.nasa.gov/wms", "AVHRR_SST_M", {
        category: "overlay",
        displayName: "Sea Surface Temperature",
        enabled: false,
        opacity: 0.80
    });
    globe.addLayerFromWms("https://neo.sci.gsfc.nasa.gov/wms", "MOD14A1_M_FIRE", {
        category: "overlay",
        displayName: "Active Fires",
        enabled: false,
        opacity: 0.80
    });
    globe.addLayerFromWms("https://neo.sci.gsfc.nasa.gov/wms", "MOD17A2_M_PSN", {
        category: "overlay",
        displayName: "Net Primary Productivity",
        enabled: false,
        opacity: 0.80
    });
    globe.addLayerFromWms("https://neo.sci.gsfc.nasa.gov/wms", "GEBCO_BATHY", {
        category: "overlay",
        displayName: "Bathymetry",
        enabled: false,
        opacity: 0.80
    });
    globe.addLayerFromWms("https://neo.sci.gsfc.nasa.gov/wms", "CERES_INSOL_M", {
        category: "overlay",
        displayName: "Solar Insolation",
        enabled: false,
        opacity: 0.60
    });
    globe.addLayerFromWms("https://neo.sci.gsfc.nasa.gov/wms", "AURA_UVI_CLIM_M", {
        category: "overlay",
        displayName: "UV Index",
        enabled: false,
        opacity: 0.80
    });
    globe.addLayerFromWms("https://neo.sci.gsfc.nasa.gov/wms", "AURA_NO2_M", {
        category: "overlay",
        displayName: "Nitrogen Dioxide Concentration",
        enabled: false,
        opacity: 0.70
    });
    globe.addLayerFromWms("https://neo.sci.gsfc.nasa.gov/wms", "MODAL2_M_SKY_WV", {
        category: "overlay",
        displayName: "Water Vapour",
        enabled: false,
        opacity: 0.65
    });
    globe.addLayerFromWms("https://neo.sci.gsfc.nasa.gov/wms", "SEDAC_POP", {
        category: "overlay",
        displayName: "Population Density",
        enabled: false,
        opacity: 0.70
    });
    globe.addLayerFromWms("https://neo.sci.gsfc.nasa.gov/wms", "TRMM_3B43M", {
        category: "overlay",
